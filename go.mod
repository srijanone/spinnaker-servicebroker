...
require (
	...
	github.com/kubernetes-sigs/go-open-service-broker-client v0.0.0-20180928143052-79b374a2302f
	...
	github.com/pmorie/osb-starter-pack v0.0.0-20180327051653-0ea21d12ee89
